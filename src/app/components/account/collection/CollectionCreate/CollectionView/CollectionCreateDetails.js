    ...
    return (
            <div className="create__details">
                    ...
                    <div className="details__body">
                        ...
                        <input name="collectionTitle" className="details__description" type="text" size="46" placeholder="Type here" onChange={functions.handleChange} value={state.collectionTitle} required />
                        ...
                        <div className="details__buttons">
                            <button onClick={functions.submit} class="green--button"> { state.edit ? "edit collection" : "create collection" } </button>
